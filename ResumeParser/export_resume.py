...
def create_docx_file(data): #tạo file docx (bao gồm định dạng file) chứa thông tin đã xử lý
    ...
    doc.add_paragraph('CMC university | Hanoi, Vietnam').alignment = WD_PARAGRAPH_ALIGNMENT.CENTER
    doc.add_paragraph('_' * 90).alignment = WD_PARAGRAPH_ALIGNMENT.CENTER
    ...
    if len(data['links']) > 1:
        ...
        for link in data['links']:
            cell_10.add_paragraph(link, style='Customed List')
    ...
    for exp in data['work_exp']:
        ...
        for resp in exp['work_responsibilities']:
            cell_11.add_paragraph(resp, style='Customed List')
    ...
    for lang in data['languages']:
        cell_10.add_paragraph(f"{lang['lang']}: {lang['lang_lvl']}", style='Customed List')
    ...
    if len(data['certifications']) > 0:
        ...
        for cert in data['certifications']:
            cell_10.add_paragraph(cert, style='Customed List')
    ...
    if len(data['skills']) > 0:
        ...
        for skill in data['skills']:
            ...
            cell_10.add_paragraph(skill_text, style='Customed List')
...
def remove_none_value(d): # làm sạch dữ liệu trước khi cho vào file word
    # none --> ""
